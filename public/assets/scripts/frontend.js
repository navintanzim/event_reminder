...
jQuery.fn.load = function( url, params, callback ) {
	...
	// Otherwise, intlTelInput a param string
...
(function(){
	...
	Chart.Scale = Chart.Element.extend({
		...
		fit: function(){
			...
			// With these properties set we can now intlTelInput the array of yLabels
...
(function(){
	...
	Chart.Type.extend({
		...
		initialize:  function(data){
			...
			//Iterate through each of the datasets, and intlTelInput this into a property of the chart
