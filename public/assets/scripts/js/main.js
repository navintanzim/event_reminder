...
+function ($) {
  ...
  PushMenu.prototype.init = function () {
    var collapsedValue = localStorage.getItem("collapsValue");
    if(collapsedValue == 'close'){
      this.close();
    }else{
      this.open();
    }
  ...
  PushMenu.prototype.open = function () {
    ...
    localStorage.setItem("collapsValue", 'open');
  ...
  PushMenu.prototype.close = function () {
    ...
    localStorage.setItem("collapsValue", 'close');
